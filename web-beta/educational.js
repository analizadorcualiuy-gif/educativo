    ...
    "jornadas_ipes": {
        ...
        "categories": [
            [
                ...
                "#2563eb",
                "Herramientas y dinámicas utilizadas en clase y evaluación: Kahoot, CREA, rúbricas, videos, IA generativa, etc."
            ],
            [
                "sub-ia-gen",
                "cat-usos-eval",
                ...
                "#0284c7",
                "Generación de imágenes, canciones, historias, prompts para planificación docente y actividades con ChatGPT, Suno, Canva."
            ],
            [
                "cat-beneficios",
                null,
                ...
                "#059669",
                "Ventajas percibidas: motivación estudiantil, formatos diversos, personalización de tareas y optimización de tiempo."
            ],
            [
                "cat-desafios",
                null,
                ...
                "#dc2626",
                "Obstáculos materiales y organizativos: conectividad, falta de dispositivos/cargadores, sobrecarga horaria y necesidad de capacitación práctica."
            ]
        ],
        "documents": [
            [
    ...
    "primer_anio": {
        ...
        "categories": [
            [
                ...
                "#0f766e",
                "Estrategias y dificultades para organizar el estudio, comprender textos académicos y cumplir con las exigencias curriculares."
            ],
            [
                "sub-autonomia",
                "cat-adaptacion",
                ...
                "#14b8a6",
                "Desarrollo de métodos propios de estudio, gestión del tiempo, búsqueda bibliográfica independiente y formulación de consultas."
            ],
            [
                "cat-apoyo",
                null,
                ...
                "#2563eb",
                "Vínculos con compañeros, grupos de estudio, tutorías docentes y contención familiar que sostienen la trayectoria."
            ],
            [
                "cat-incertidumbre",
                null,
                ...
                "#b45309",
                "Dudas vocacionales, temor al fracaso, estrés ante evaluaciones y vivencia de desorientación al inicio de la carrera."
            ]
        ],
        "documents": [
            [
    ...
    "retroalimentacion": {
        ...
        "categories": [
            [
                ...
                "#0f766e",
                "Devoluciones que explican logros alcanzados, señalan debilidades argumentativas y ofrecen pautas concretas para mejorar."
            ],
            [
                "sub-criterios",
                "cat-clara",
                ...
                "#14b8a6",
                "Uso de matrices de evaluación, rúbricas conocidas de antemano y referencias explícitas a los objetivos de aprendizaje."
            ],
            [
                "cat-emocion",
                null,
                ...
                "#9333ea",
                "Reacciones emocionales ante la corrección: frustración, ansiedad, sensación de injusticia, desmotivación o alivio y entusiasmo."
            ],
            [
                "cat-dialogo",
                null,
                ...
                "#2563eb",
                "Instancias de intercambio presencial, posibilidad de repreguntar, aclarar dudas y reentregar trabajos reelaborados."
            ]
        ],
        "documents": [
            [
